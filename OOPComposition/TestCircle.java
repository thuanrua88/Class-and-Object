...
public class TestCircle {
    public static void main(String[] args) {
        ...
        System.out.printf("circumferece is : %.2f%n", c1.getCircumference());

        System.out.printf("distace is %.2f%n", c1.distance(c2));
        System.out.printf("distace is %.2f%n", c2.distance(c1));
    }
}
